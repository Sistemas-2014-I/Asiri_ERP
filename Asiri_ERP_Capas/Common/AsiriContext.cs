namespace Common
{
    ...
    public partial class AsiriContext : DbContext
    {
        ...
        public virtual DbSet<AspNetPermisos> AspNetPermisos { get; set; }
        ...
        public virtual DbSet<CustomPermiso> CustomPermiso { get; set; }
        ...
        public virtual DbSet<PermisoMenu> PermisoMenu { get; set; }
        ...
        public virtual DbSet<TNSt07_numeracion> TNSt07_numeracion { get; set; }
        ...
        {
            modelBuilder.Entity<AspNetPermisos>()
                .Property(e => e.Descripcion)
                .IsUnicode(false);

            modelBuilder.Entity<AspNetPermisos>()
                .HasMany(e => e.AspNetRoles)
                .WithMany(e => e.AspNetPermisos)
                .Map(m => m.ToTable("AspNetRolesPermisos").MapLeftKey("PermisoId").MapRightKey("RoleId"));
            ...
            modelBuilder.Entity<AspNetUsers>()
                .HasMany(e => e.CustomPermiso)
                .WithRequired(e => e.AspNetUsers)
                .HasForeignKey(e => e.UserID)
                .WillCascadeOnDelete(false);

            modelBuilder.Entity<AspNetUsers>()
                .HasMany(e => e.MenuTemp)
                .WithRequired(e => e.AspNetUsers)
                .HasForeignKey(e => e.UserID)
                .WillCascadeOnDelete(false);
            ...
            modelBuilder.Entity<TNSt07_numeracion>()
                .Property(e => e.serie)
                .IsUnicode(false);

            modelBuilder.Entity<TNSt07_numeracion>()
                .Property(e => e.num_corr_inicial)
                .IsUnicode(false);

            modelBuilder.Entity<TNSt07_numeracion>()
                .Property(e => e.num_corr_final)
                .IsUnicode(false);

            modelBuilder.Entity<TNSt07_numeracion>()
                .Property(e => e.num_corr_actual)
                .IsUnicode(false);
